...
var WorkflowEditorViewModel = function (layout_json, workflow_json, credentials_json, workflow_properties_json, subworkflows_json, can_edit_json) {
  ...
  self.draggableShellAction = ko.observable(bareWidgetBuilder("ETL", "shell-widget"));
  ...
  self.draggableSparkAction = ko.observable(bareWidgetBuilder("Veritca Copy", "spark-widget"));
